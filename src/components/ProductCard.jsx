...
export const ProductCard = (props) => {
  ...
  return (
    <div className='w-60 lg:w-80 rounded-[0.75em] bg-blue-black'> 
        <div className=" flex flex-col py-4 px-8 md:py-6 md:px-12 productCard-inner">
            <img className='self-center w-60 md:w-64 h-full rounded-[0.75em] object-cover' src={props.image.img} alt={props.image.alt}></img>
