...
export const InfoCard = () => {
    return (
        <div className="fixed hidden lg:block bottom-6 right-6 z-50">
            <div class="rounded-xl bg-[#F7FBFC] overflow-hidden relative text-center p-4 group items-center flex flex-col max-w-xs hover:shadow-2xl transition-all duration-300 shadow-xl">
                <div class="text-[#526D82] group-hover:scale-105 transition-all">
                    <svg
                        class="w-8 h-8"
                        stroke="currentColor"
                        stroke-width="1.5"
                ...
                <div class="flex items-center transition-all duration-300  group-hover:bottom-3 -bottom-full absolute gap-2 justify-evenly w-full">
                    <div class="flex gap-3 text-2xl text-[#526D82] p-1 hover:p-2 transition-all duration-300  rounded-full shadow-sm">
                        <a href="https://github.com/sotirisanastjm" target="_blank" aria-label="Github" class="hover:scale-110 transition-all duration-300 ">
                            <svg
                                width="24px"
                                height="24px"
                                fill="currentColor"
                        ...
                        <a href="https://sotirisanast.netlify.app/" target="_blank" aria-label="Bio Website" class="hover:scale-110 transition-all duration-300 ">
                        ...
                        <a href="https://gr.linkedin.com/in/sotiris-anastasiadis" target="_blank" aria-label="LinkedIn" class="hover:scale-110 transition-all duration-300 ">
                            <svg
                                width="24px"
                                height="24px"
                                fill="currentColor"
